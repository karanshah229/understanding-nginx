...
# Architect decision: Lower concurrency for CPU-bound tasks.
# Too many connections will just lead to massive timeouts; 
# we want to see saturation, not just connection termination.
DURATION=60
CONCURRENCY=30
...
echo "------------------------------------------------------------"
echo "Experiment 8: CPU-bound Backend"
echo "------------------------------------------------------------"
...
echo "Step 1: CPU STRESS (Lower Concurrency, $CONCURRENCY connections)"
